...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Charts Issued by CA
        $IssuerCNTR = Cert::where('issuerCN', 'like', '%TRAGSA%')->count();
        ...
        $certs_issued_by->dataset('Nº of Issued By each CA', 'bar', [$IssuerCNTR, $IssuerCNFP, $IssuerCNDC, $IssuerCNSY, $IssuerCNVE, $IssuerCNLE1, $IssuerCNLE2 ])
